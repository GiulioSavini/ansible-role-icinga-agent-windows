...
|---|---|---|---|
| `icinga_director_url` | yes | `https://monitor.irideos.it/neteye/director/` | NetEye/Icinga Director URL |
...
- hosts: windows_servers
  ...
  roles:
    - role: giuliosavini.icinga_agent_windows
      icinga_director_url: "https://monitor.example.com/neteye/director/"
      icinga_self_service_api_key: "aadc1c7513b7e989365c7fa7b5a69b7032f41f70"
```
